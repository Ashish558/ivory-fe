         ...
         <div class="navbar-end pr-28">
            ...
            <div className=' dropdown  dropdown-end '>
               <label tabindex="0" className='cursor-pointer'>
                  {
                     loggedIn &&
                     <p ><img width="34px" height="34px" src={profileData.profile_picture ? profileData.profile_picture : User} alt="profile_picture" className='rounded-full w-[40px] h-[40px] object-cover' /></p>
                  }
               </label>
                  ...
                  <div class="flex flex-col">
                        ...
                        <div className='flex justify-between'>
                           {
                              loggedIn &&
                              <p className='pl-11'>
                                 <img src={profileData.profile_picture ? profileData.profile_picture : User} width="48px" alt="profile_picture" className='rounded-full  w-[40px] h-[40px] object-cover' />
                              </p>
                           }
                           <p onClick={handleSidebar} className='pr-7'><img className='cursor-pointer' src={cross} alt="cross" />
                           </p>
                        </div>
                     ...
                     <div className='flex  justify-between px-4'>
                        <div>
                           ...
                           <div className='flex  items-center  mt-7 p-3  cursor-pointer hover:bg-[#CDF7FF] rounded-md' onClick={handleSidebar}>
                              <p onClick={handleSidebar}><img src={sessions} alt="sessions" /></p>
                        ...
                        <div className=''>
                           <div className='flex  items-center cursor-pointer p-3 hover:bg-[#CDF7FF] rounded-md  mt-7'
                              ...
                              <p onClick={handleSidebar}><img src={exit} alt="exit" /></p>
                              <p className='text-sm font-semibold pl-4'> My Sign out</p>
                           </div>
                           <div className='flex  items-center  mt-7 p-3  cursor-pointer hover:bg-[#CDF7FF] rounded-md' onClick={handleSidebar}>
                              <p onClick={handleSidebar}><img src={faq} alt="faq" /></p>
                              <p className='text-sm font-semibold pl-4'> My FAQ</p>
                           </div>
                           <div className='flex  items-center mt-7 p-3 cursor-pointer  hover:bg-[#CDF7FF] rounded-md' onClick={handleSidebar}>
                              <p onClick={handleSidebar}><img src={contact} alt="contact" /></p>
