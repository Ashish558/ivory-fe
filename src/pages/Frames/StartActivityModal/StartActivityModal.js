...
export default function StartActivityModal({ handleClose, activityId, setIsAlreadyStarted, fetchUserActivities, profileData, fetchUserDetails, handleStartActivity, startBtnLoading }) {
