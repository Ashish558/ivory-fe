    ...
    <>
      <div className='h-16 w-11/12  flex justify-around border-b mx-4 border-slate-400'>
       ...
       <div>
        ...
        <img className='h-48 sm:rounded-3xl sm:w-[100%] object-cover sm:mx-0 mx-auto' src={paint} alt="" />
        </div>
        <div>
...
Share</button>
       ...
       <div className='h-32 w-11/12  flex border-b mx-2 border-slate-400'>
          <div className='h-28 w-36 rounded-xl mt-2 mx-4 bg-gray pt-5 px-10'><img className='h-16 w-16 ' src={note} alt="" /></div>
