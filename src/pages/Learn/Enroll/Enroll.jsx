      ...
      <div className="w-[400px] mt-28 ml-5 hidden sm:block">
        <div className="enrollFooter bg-sky-100 border-2 border-blue-400 flex flex-col py-5 mb-20">
          ...
          <div className="text-gray-500 text-lg ml-6 ">
            ...
            <button className="bg-blue-800 text-white font-semibold py-2 w-[90%] rounded-full border mx-auto  self-center my-2">
              {" "}
              Pay $ 1200 to Enroll
            </button>
            <button className="bg-whte text-[#1B72C0] font-semibold py-2 w-[90%] rounded-full border-2 mt-5 border-[#1B72C0] mx-auto  self-center">
              {" "}
              Share
            </button>
          </div>
